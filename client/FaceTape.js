...
function documentReady(){
            ...
            pushNotifiPopup(pushpic,pushmsg)
            setTimeout(snapy,50);
...
function bindEvents(){
    try{
        ...
        $("#pushimagePopUp").hammer().on("tap",function(){
