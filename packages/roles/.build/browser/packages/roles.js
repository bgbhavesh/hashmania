...
Roles._handlebarsHelpers = {                                                                               // 21
  ...
  isInRole: function (role, group) {                                                                       // 44
    ...
    return Roles.userIsInRole(user, roles)                                                                 // 68
                                                                                                           ...
                                                                                                           // 71
                                                                                                           // 72
if ('undefined' !== typeof Handlebars) {                                                                   // 73
  _.each(Roles._handlebarsHelpers, function (func, name) {                                                 // 74
    Handlebars.registerHelper(name, func)                                                                  // 75
  })                                                                                                       // 76
} else {                                                                                                   // 77
  console.log('WARNING: Roles Handlebars helpers not registered. Handlebars not defined')                  // 78
}                                                                                                          // 79
                                                                                                           // 80
}());                                                                                                      // 81
                                                                                                           // 82
