(function(){/* Parsley dist/parsley-standalone.min.js build version 1.1.17 http://parsleyjs.org */
...
d.map=function(f,a){var b,c=[],e;if(m(f))for(e=0;e<f.length;e++)b=a(f[e],e),null!=b&&c.push(b);else for(e in f)b=a(f[e],e),null!=b&&c.push(b);return 0<c.length?d.fn.concat.apply([],c):c};d.each=function(a,d){var b;if(m(a))for(b=0;b<a.length&&!1!==d.call(a[b],b,a[b]);b++);else for(b in a)if(!1===d.call(a[b],b,a[b]))break;return a};d.grep=function(a,d){return v.call(a,d)};window.JSON&&(d.parseJSON=JSON.parse);d.fn={forEach:z.forEach,reduce:z.reduce,push:z.push,sort:z.sort,indexOf:z.indexOf,concat:z.concat,
...
n?0<this.length?this[0].textContent:null:this.each(function(){this.textContent=a})},attr:function(a,b){var d;return"string"==typeof a&&b===n?0==this.length||1!==this[0].nodeType?n:"value"==a&&"INPUT"==this[0].nodeName?this.val():!(d=this[0].getAttribute(a))&&a in this[0]?this[0][a]:d:this.each(function(d){if(1===this.nodeType)if(l(a))for(s in a){d=s;var c=a[s];null==c?this.removeAttribute(d):this.setAttribute(d,c)}else d=k(this,b,d,this.getAttribute(a)),null==d?this.removeAttribute(a):this.setAttribute(a,
...
a[b]},destroy:function(){this.$element.removeClass("parsley-validated");this.reset().$element.off("."+this.type).removeData(this.type)}};var p=function(a,b,e){this.initMultiple(a,b);this.inherit(a,b);this.Validator=new l(b);this.init(a,e||"ParsleyFieldMultiple")};p.prototype={constructor:p,initMultiple:function(a,c){this.element=a;this.$element=b(a);this.group=c.group||!1;this.hash=this.getName();this.siblings=this.group?'[data-group="'+this.group+'"]':'input[name="'+this.$element.attr("name")+'"]';
this.isRadioOrCheckbox=!0;this.isRadio=this.$element.is("input[type=radio]");this.isCheckbox=this.$element.is("input[type=checkbox]");this.errorClassHandler=c.errors.classHandler(a,this.isRadioOrCheckbox)||this.$element.parent()},inherit:function(a,b){var e=new q(a,b,"ParsleyFieldMultiple"),g;for(g in e)"undefined"===typeof this[g]&&(this[g]=e[g])},getName:function(){if(this.group)return"parsley-"+this.group;if("undefined"===typeof this.$element.attr("name"))throw"A radio / checkbox input must have a data-group attribute or a name to be Parsley validated !";
